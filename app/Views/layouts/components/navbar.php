                ...
                <ul class="navbar-nav ms-auto mb-lg-0">
                    ...
                    <li class="nav-item dropdown me-3">
                        <a class="nav-link position-relative" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" 
                                ...
                                echo $lowStockCount > 0 ? $lowStockCount : '';
                                ?>
                            </span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end notification-dropdown" style="min-width: 350px;">
                            <li class="dropdown-header d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted"><?= $lowStockCount ?> peringatan</small>
                            </li>
                            
                            <?php if ($lowStockCount > 0): ?>
                                <?php $lowStockProducts = $productModel->getLowStockProducts(5); ?>
                                       ...
                                       href="<?= base_url('/products/show/' . $product['id']) ?>">
                                        <div class="d-flex">
                                            ...
                                            <div class="notification-content flex-grow-1">
                                                <h6 class="notification-title mb-1">Stok Rendah!</h6>
                                ...
                                <li>
                                    <a class="dropdown-item text-center text-primary" 
                                       href="<?= base_url('/stock/alerts') ?>">
                                        <i class="bi bi-eye"></i> Lihat Semua Peringatan
                                    </a>
                                </li>
                            <?php else: ?>
                                <li>
                                    <div class="dropdown-item-text text-center py-4">
                                        ...
                                        <p class="mb-0">Tidak ada peringatan</p>
                                        <small class="text-muted">Semua stok dalam kondisi normal</small>
                                    </div>
                                </li>
                            <?php endif ?>
                        </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="min-width: 200px;">
                            <li>
                                <h6 class="dropdown-header">
                                    <i class="bi bi-person-circle"></i> Hello, Admin!
                                </h6>
                            </li>
                            <li>
